"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_landing-js_handyman_js"],{

/***/ "./resources/landing-js/handyman.js":
/*!******************************************!*\
  !*** ./resources/landing-js/handyman.js ***!
  \******************************************/
...
(function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.change-mode').on('click', function () {
      var value = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).data('change-mode');
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).data('change-mode', value === 'dark' ? 'light' : 'dark');
      if (value === 'dark') {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').removeClass('dark');
      } else {
